...
namespace DbMock1G4.DataAccess
{
    public class SqlHelper
    {
        ...
        // Kiểm tra giá trị của đối tượng đầu vào
        ...
        // Lấy ra chuỗi SqlConnection hiện tại đang giao dịch
        ...
        // thực thi 1 câu lệnh Sql có 3 tham số truyền vào:connection, commandType,commandText
        ...
        // thực thi 1 câu lệnh Sql có 3 tham số truyền vào:connection, commandType,commandText,tham số của các đối tương
 ...
 // hàm thực thi truy vấn và trả 1 1 datâtble cho người dùng
        ...
        // Phương thức thực thu không trả về giá trị
        ...
        public static object ExecuteScalar(string connectionString, CommandType commandType, string commandText, params object[] parameters)
        {
            if (Transaction.Current == null)
            {
                SqlConnection connection = new SqlConnection(connectionString);
