<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintReceipt.aspx.cs" Inherits="WebApplication1.UC2.WithdrawMoney.PrintReceipt1" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-8 table-bordered">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-9">
                                ...
                                <h4>Do you want print receipt?</h4>
                                <br />
                                <br />
                                <div class="col-md-12">
                                    <div class="col-md-4 col-lg-offset-8 col">
                                        <input type="text" class="btn btn-primary btn1 col" value="OK" />
                                    </div>
                                    <div class="col-md-4 col-lg-offset-8 col">
                                        <input type="text" class="btn btn-primary btn1 col" value="Cancel" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                <td>
                                    <asp:Button runat="server" ID="btnOk" CssClass="btn btn-primary btn1" Text="Buttom 5" OnClick="btnOk_Click" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Button runat="server" ID="btnCancelPrint" CssClass="btn btn-primary btn1" Text="Buttom 6" OnClick="btnCancelPrint_Click" />
